...
const Navbar = () => {
    ...
    return (
        <>
            {showNavbar && <nav className='bg-white w-[90vw] fixed top-10 right-[5vw] rounded-full px-7 py-4 flex justify-between'>
                <div className='logo flex gap-8 justify-center items-center'>
                    <Link href={"/"}>
                    ...
                    <ul className='flex gap-8 items-center'>
                        <Link href="/"><li className='hover:bg-gray-200 hover:p-2 rounded-lg'>Templates</li></Link>
                        <Link href="/"><li className='hover:bg-gray-200 hover:p-2 rounded-lg'>Marketplace</li></Link>
                        <Link href="/"><li className='hover:bg-gray-200 hover:p-2 rounded-lg'>Discover</li></Link>
                        <Link href="/"><li className='hover:bg-gray-200 hover:p-2 rounded-lg'>Pricing</li></Link>
                        <Link href="/"><li className='hover:bg-gray-200 hover:p-2 rounded-lg'>Learn</li></Link>
                    </ul>
                </div>
